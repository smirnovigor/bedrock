...
declare const DeleteAgentAliasCommand_base: {
    ...
    new (__0_0: DeleteAgentAliasCommandInput): import("@smithy/smithy-client").CommandImpl<DeleteAgentAliasCommandInput, DeleteAgentAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
