...
declare const GetAgentAliasCommand_base: {
    ...
    new (__0_0: GetAgentAliasCommandInput): import("@smithy/smithy-client").CommandImpl<GetAgentAliasCommandInput, GetAgentAliasCommandOutput, BedrockAgentClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
